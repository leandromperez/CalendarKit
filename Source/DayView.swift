...
public class DayView: UIView, EventViewDelegate, TimelinePagerViewDelegate {
    ...
    public init(calendar: Calendar = Calendar.autoupdatingCurrent, style: CalendarStyle) {
        self.calendar = calendar
        self.dayHeaderView = DayHeaderView(calendar: calendar, style: style.header)
        self.timelinePagerView = TimelinePagerView(calendar: calendar, style: style.timeline)
        self.style = style
